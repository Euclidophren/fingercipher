...
class SM4(BaseBlock):
    def __init__(self, key_length, key):
        ...
        self.FK = {0x0: 0xA3B1BAC6, 0x1: 0x56AA3350, 0x2: 0x677D9197, 0x3: 0xB27022DC}
    ...
    def RLS32(self, input: int, shift_amount: int) -> int:
        input %= 0x100000000
    ...
    def T(self, input: int) -> int:
        return self.L(self.tau(input))

    def L_prime(self, B: int) -> int:
        return B ^ self.RLS32(B, 13) ^ self.RLS32(B, 23)

    def T_prime(input: int) -> int:
        return self.L_prime(self.tau(input))

    def key_expand(self, MK: tuple) -> list:
        K = dict()
